...
const notices = [
    ...
    { date: "2024.03.14 ~ 2025.04.03", title: "공통PJT 및 개인PJT",  content: "공통 주제 프로젝트 교육 / SW이론 교육과 동시에 병행행" },
        ...
        <div className={styles.container}>
            <div className={styles.wrap}>
                ...
                <div className={styles.buttonWrap}>
                    {["공지작성", "설문작성"].map((text, i) => (
                        <div key={i} className={styles.button} onClick={() => toggleModal(i === 0 ? 'notice' : 'survey')}>
            ...
            <div className={styles.wrap}>
                <div className={styles.surveySection}>
                    <div className={styles.surveyHeader}><div className={styles.surveyTitle}>설문조사</div></div>
                    ...
                    <div className={styles.surveyContent}>
                        {surveys.map((survey, i) => (
                            <div key={i} className={styles.surveyItem}>
                                ...
                                <div className={styles.surveyButton}><div className={styles.buttonText}>설문참여</div></div>
                            </div>
                        ))}
                    </div>
